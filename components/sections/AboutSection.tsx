    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6">
      <div className="grid gap-10 sm:gap-12 lg:grid-cols-2 lg:items-start">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
          {/* Card 1 */}
          <div className="rounded-lg border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-5 sm:p-6 transition hover:shadow-md">
            <IconWrapper>
            ...
            <h3 className="font-semibold text-slate-900 dark:text-white">IoT Expertise</h3>
          ...
          <div className="rounded-lg border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-5 sm:p-6 transition hover:shadow-md">
            ...
            <h3 className="font-semibold text-slate-900 dark:text-white">Scalable Platform</h3>
            <p className="mt-2 text-sm text-slate-600 dark:text-slate-300">
          ...
          <div className="rounded-lg border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-5 sm:p-6 transition hover:shadow-md">
            ...
            <h3 className="font-semibold text-slate-900 dark:text-white">Secure by Design</h3>
            <p className="mt-2 text-sm text-slate-600 dark:text-slate-300">
